...
public class ReunionVirtual extends Reunion {
     ...
     */
    public ReunionVirtual(Empleado organizador, int id, Date fecha, Instant horaPrevista, Duration duracionPrevista, Instant horaInicio, Instant horaFin, String enlace) {
